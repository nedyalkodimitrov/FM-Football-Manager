 ...
 * CoacheStatus
 *
 * @ORM\Table(name="coache_status")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CoacheStatusRepository")
 */
class CoacheStatus
{
    /**
     ...
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Coaches", inversedBy="treatmentInformation")
